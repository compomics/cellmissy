...
public interface SingleCellOperator {
     ...
     * @param singleCellConditionDataHolder
     */
    void generateEndPointDirectionalityRatiosVector(SingleCellConditionDataHolder
     ...
     * @param singleCellConditionDataHolder
     */
    void generateMedianDirectionAutocorrelationsVector(SingleCellConditionDataHolder
                                                               singleCellConditionDataHolder);
