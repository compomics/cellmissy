...
public class StepCentricOperatorTest {
    ...
    public void testComputations() {
        ...
        Assert.assertEquals(1.0, timeZero[0], 0);
        ...
        Assert.assertEquals(0.351, AnalysisUtils.roundThreeDecimals(timeOne[0]), 0);
        Assert.assertEquals(0.447, AnalysisUtils.roundThreeDecimals(timeOne[1]), 0);
