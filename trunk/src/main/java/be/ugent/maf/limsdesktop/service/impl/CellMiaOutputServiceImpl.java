...
import be.ugent.maf.limsdesktop.parser.CellMiaFileParser;
import be.ugent.maf.limsdesktop.parser.impl.CellMiaFileParserImpl;
import be.ugent.maf.limsdesktop.repository.WellHasImagingTypeRepository;
import be.ugent.maf.limsdesktop.service.CellMiaOutputService;
