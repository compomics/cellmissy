 ...
 */
public class SingleCellAnalysisInfoDialog extends javax.swing.JDialog {

    /**
     * Creates new form SingleCellAnalysisInfoDialog
     */
    public SingleCellAnalysisInfoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(infoScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SingleCellAnalysisInfoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SingleCellAnalysisInfoDialog dialog = new SingleCellAnalysisInfoDialog(new javax.swing.JFrame(), true);
